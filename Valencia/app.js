        ...
        container.innerHTML = `
            <div class="viability-category">
                ...
                <div class="viability-card info-card">
                    <div class="card-title-sec">
                        <span class="monument-name">L'Oceanogràfic & Museo de las Ciencias</span>
                        <span class="warning-badge">Altamente Recomendado</span>
                    </div>
                    <div class="card-body-sec">
                        <p><strong>Aviso:</strong> Oceanogràfic es la visita donde una pequeña variación de aforo o cola puede desordenar el itinerario. Compra online muy recomendada.</p>
                    </div>
                </div>

                <div class="viability-card info-card">
                    <div class="card-title-sec">
                        <span class="monument-name">Bioparc Valencia</span>
                        <span class="info-badge">Comprar Online</span>
                    </div>
                    <div class="card-body-sec">
                        <p><strong>Aviso:</strong> Suele requerir media jornada larga. Comprar con antelación para asegurar acceso y evitar colas de taquilla.</p>
                    </div>
                </div>

                <div class="viability-card info-card">
                    <div class="card-title-sec">
                        <span class="monument-name">Mestalla Forever Tour</span>
                        <span class="info-badge">Reconfirmar Horario</span>
                    </div>
                    <div class="card-body-sec">
                        <p><strong>Aviso:</strong> Depende de la programación deportiva. Reconfirmar el horario del último pase vespertino (usualmente 17:30 hs).</p>
                    </div>
                </div>

                <div class="viability-card info-card">
                    <div class="card-title-sec">
                        <span class="monument-name">Catedral y San Nicolás</span>
                        <span class="info-badge">Opcional</span>
                    </div>
                    <div class="card-body-sec">
                        <p><strong>Aviso:</strong> Si queréis asegurar una franja horaria concreta sin esperas, es recomendable la reserva previa.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="viability-category">
                ...
                <div class="viability-card alert-card">
                    <div class="card-title-sec">
                        <span class="alert-title-text"><i class="fa-solid fa-calendar-check"></i> Horarios Oficiales</span>
                    </div>
                    <div class="card-body-sec">
                        <p>Se debe reconfirmar días antes del viaje el horario exacto del <strong>Museu de les Ciències, Lonja de la Seda y Torres de Serranos</strong> debido a festivos y variaciones estacionales.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="viability-category" style="margin-bottom:20px;">
                ...
                <div class="viability-card info-card">
                    <p style="font-size: 13px; line-height: 1.5; color: var(--text-muted); padding: 8px;">
                        Plaza de la Virgen, Barrio del Carmen, Jardín del Turia, Parque Gulliver, playas, Marina y El Cabañal no tienen ticket ni reserva. Conviene dejar margen de tiempo por cansancio, clima y traslados con los niños.
                    </p>
                </div>
            </div>
        `;
